...
class HistogramChartEncodings:
    ...
    color: str = chrt.COLORS["amtk_blue"]  # -> alt.value()
...
class HistogramChart:
    ...
    Fields:
        ...
        encode (pchrt.HistogramChartEncodings): chart encodings
    ...
    encode: pchrt.HistogramChartEncodings = field(default_factory=HistogramChartEncodings)
